...
function StepCard({ step }: { step: (typeof steps)[0] }) {
  ...
  return (
    ...
    >
      <div       className="relative z-10 flex flex-col items-center rounded-2xl border border-slate-700/50 bg-gradient-to-b from-slate-800/80 to-slate-900/80 p-8 backdrop-blur-sm transition-all duration-500 hover:border-white/30 hover:shadow-[0_0_40px_-12px_rgba(255,255,255,0.15)]">
        {/* Glow on hover */}
        ...
        <div className="relative mb-5">
          <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-white/20 to-white/10 ring-1 ring-white/30 transition-all duration-500 group-hover:ring-white/50 group-hover:shadow-[0_0_20px_-4px_rgba(255,255,255,0.2)]">
            <Icon className="h-6 w-6 text-white" strokeWidth={1.5} />
          </div>
          <span className="absolute -right-2 -top-2 flex h-7 w-7 items-center justify-center rounded-full bg-white text-xs font-bold text-[#050B1A] shadow-lg shadow-white/20">
            {step.number}
          </span>
        </div>
        ...
        <div className="absolute -bottom-12 left-1/2 z-20 hidden -translate-x-1/2 lg:block">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" className="text-slate-600 transition-colors duration-300 group-hover:text-white/50">
            <path d="M5 12h14M13 5l7 7-7 7" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
        </div>

        <h3 className="text-center text-lg font-bold text-white transition-colors duration-300 group-hover:text-white">
          {step.title}
        </h3>
  ...
  return (
    <>
      ...
      >
        ...
        <div className="sticky top-0 flex h-screen items-center overflow-hidden">
          <div className="ml-[5vw]">
            ...
            >
              <span className="inline-block text-xs font-bold uppercase tracking-[0.25em] text-white">
                Our Process
              </span>
              <h2 className="mt-3 font-serif text-4xl font-bold tracking-tight text-white md:text-5xl">
                How We Work
              </h2>
              <div className="mt-4 h-0.5 w-16 bg-gradient-to-r from-white to-white/70" />
            </motion.div>
          </div>
          ...
          >
            {/* Connecting line */}
            <div className="pointer-events-none absolute left-0 right-0 top-1/2 h-px -translate-y-1/2 bg-gradient-to-r from-transparent via-white/20 to-transparent" />
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 px-6 py-24 md:hidden">
        ...
        />
        <div className="absolute left-1/3 top-1/4 h-64 w-64 rounded-full bg-white/5 blur-3xl" />
        ...
        <div className="relative z-10 mx-auto max-w-lg">
          <div className="mb-12 text-center">
            ...
            <div className="mx-auto mt-4 h-0.5 w-16 bg-gradient-to-r from-white to-white/70" />
          </div>
          ...
          >
            ...
            <div className="absolute left-8 top-0 h-full w-px bg-gradient-to-b from-white/30 via-white/10 to-transparent" />
            ...
            <div className="space-y-8">
              {steps.map((step) => {
                ...
                return (
                  ...
                  >
                    {/* Icon circle */}
                    <div className="relative z-10 flex h-16 w-16 flex-shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-white/20 to-white/10 ring-1 ring-white/30">
                      <Icon className="h-6 w-6 text-white" strokeWidth={1.5} />
                      <span className="absolute -right-1.5 -top-1.5 flex h-6 w-6 items-center justify-center rounded-full bg-white text-[10px] font-bold text-[#050B1A] shadow-lg shadow-white/20">
                        {step.number}
                      </span>
                    </div>
